...
const EditNowComponent = () => {
    ...
    const section2 = [
        ...
        { key: 'Martial Status', icon: <AntDesign name="heart" size={18} color="black" />, data: { name: state.maritalStatus } },
        ...
        { key: 'Caste', icon: <FontAwesome5 name="praying-hands" size={18} color="black" />, data: { name: state.caste } },
    ]
    ...
    const section3 = [
        ...
        { key: 'Salary', icon: <FontAwesome5 name="comments-dollar" size={20} color="black" />, data: { name: state.salary } },
    ]
